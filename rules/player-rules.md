...
- __Constitution__:
  ...
  - A higher Constitution bonus increases your Grit thresholds, staving off dangerous injuries. 
- __Intelligence__:
...
- __Charisma__:
  ...
  - PCs may employ a number of hirelings equal to their Charisma bonus. A PC may have a lifetime number of henchfolks equal to 5 + their starting Charisma bonus; Write it down during character creation.
...
When attempting something where the outcome is uncertain and failure has consequences, you make a skill check. To make a skill check, roll 2d10, then add the relevant ability bonus to the result, plus anything from action die usage. If the total is greater than 15 (so >= 16), they succeed, if not, they fail.
...
- __Action Dice__: Whenever a PC gains a template, they gain an Action Die as well. Action die are `d6`, and are used to recover Grit outside of natural rest, to modify Skill and Attack rolls, and to use specialized abilities from class templates (e.g. Spells, Influencing Morale rolls). 
- __Armor__: Armor comes with an armor value. Note that value on your character sheet, it is used to reduce damage from incoming attacks.
- __Grit__: This represents a PC's ability to mitigate grievous blows that their armor or dexterity couldn't help them avoid. PCs have maximum Grit value equal to their Constitution bonus.
...
Each class template grants specialized abilities, as well as unique ways to use Action Dice in play.

The Classes and Templates available selection should be tailored to the campaign run by the referee.

## Action Dices

Every level gained that grants a template also grants an action die to the character. Actions Dice are `d6` that may be spent during specific circumstances to improve the action being attempted.
Action dice can always be spent to recover [sum] Grit, and Classes (from which the PCs gain templates) enable additional types of use.
When a die is spent, the player rolls, even if the action attempted does not care about the resulting face, as the dices are retained when they roll a 1, 2 or 3.
...
Legendary items and Artifacts may grant characters additional Action dices. Be on the lookout for those valuable treasures!
...
| Level | Investment Threshold | Attribute Increases |
| :---: | :------------------: | :-----------------: |
|   7   |        25 000        |  +1 for 3 bonuses   |
|   8   |        50 000        |  +1 for 3 bonuses   |
|   9   |       100 000        |  +1 for 3 bonuses   |
|  10   |       200 000        |  +1 for 3 bonuses   |
|  +1   |       +200 000       |  +1 for 3 bonuses   |
...
Furthermore, as you continue to level up, you gain titles to represent acknowledgment of your deed by the powerful of the civilized world. If you are of a specific ancestry, you may choose from their title list. If you have at least 3 templates in an Occupation, you may instead choose the column matching its theme for your title progression.
...
- When you take a hit, subtract the damage incured from your current Grit.
- If damage taken would bring you to or below 0 Grit, write down your grit as 0, then roll an injury with any excess damage incured. E.g., if you currently have 3 grit remaining, take a hit worth 5 damage, you write down 0 grit remaining, then roll the injury with 2 damage suffered.
  - If you don't have any grit remaining, directly roll the injury with the amount of damage taken.
...
- If you suffer a **Major Injury**, you are out of the action until the end of the turn (usually 10 min)

To roll on the **Injuries** table, roll `1d12 + the number of injuries you currently suffer from + the damage suffered from the attack`, then diegetically adjudicate the result to the current situation. Some effect may ask you to roll a **Minor Injury**, in this case, replace the d12 with a d6.
...
|    10    |     Head wound     | Lose Action Dice equal to half your maximum (rounded up)                                                              | Disadvantage on all rolls                                                                                                          |
