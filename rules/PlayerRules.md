...
When attempting something where the outcome is uncertain and failure has consequences, you make a saving throw, or “save”. To make a save, add the bonus of the relevant ability to a d20 roll. If the total is greater than 15, your character succeeds. If not, they fail.

TODO: Distinguish between skill check and save (active roll vs passive roll)

Skill check outcomes:

* Without Tools
  * Success: Intended Result but spent time (-> encounter die roll)
  * Failure: No result and spent time
* With Tools:
  * Success: Intended Result
  * Failure: Intended Result but spent time
* With Magic:
  * See Spell specification

When attacking in melee, add your **Strength** bonus to your d20 roll.

When attacking at range, add your **Wisdom** bonus to your d20 roll.

When recuperating after a good night rest, subtract your **Constitution** from your accrued Damage.
